...
final class RegionController extends AbstractController
{
    ...
    #[Route('/front', name: 'app_region', methods: ['GET', 'POST'])]
    public function att_index(RegionRepository $regionRepository): Response
    {
        return $this->render('test/frontregion.html.twig', [
            'regions' => $regionRepository->findAll(),
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($imageFile) {
                ...
                $imageFile->move(
                    $this->getParameter('images_directory'), // Directory defined in services.yaml
                    $newFilename
                );

                // Set the image field to the new filename
